 ...
 * 
 */
@WebServiceClient(name = "QuestionWS", targetNamespace = "http://QuestionModel/", wsdlLocation = "http://localhost:8082/Stackexchange_WS/QuestionWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8082/Stackexchange_WS/QuestionWS?wsdl");
