			...
			<tbody>
				<tr>
					...
					<td>
						<table>
							<tbody>
								<tr><td><p class="content"><?php echo $question['content'];?></p></td></tr>
								<tr><td><div class="credential">asked by <?php echo $question['name'];?> at <?php echo $question['timestamp'];?> | <?php echo '<a class="yellow" href="edit.php?id='.$question['id'].'">edit</a> | <a class="delete" href="javascript:confirmDelete('.$question['id'].')">delete</a>';?></div></td></tr>
							</tbody>
						</table>
					</td>
				</tr>
						...
						<tbody>
							<tr>
								...
								<td>
									<table>
										<tbody>
											<tr><td><p class="content"><?php echo $row['content'];?></p></td></tr>
											<tr><td><div class="credential">answered by <?php echo $row['name'];?> at <?php echo $row['timestamp'];?></div></td></tr>
										</tbody>
									</table>
								</td>
							</tr>
