        ...
        <% String action = request.getParameter("action");
           ...
           if (action.equals("askhere")) {
               ...
               if (type.contains("new")) {
                   ...
                   int stats = sws.addQuestion(to,title,content);              
                   if (stats>0) {
                   ...
                   if (!owner.equals(currentl)) {
                       ...
                       m2 = "home.jsp";
                        ...
                        int stats = sws.updateQuestion(to, idd,title,content);  
                        if (stats>0) {
               ...
               if (!owner.equals(currentl)) {
                       ...
                       m2 = "home.jsp";
                        ...
                        int stats = sws.deleteQuestion(to, idd);
                   if (stats>0) {
               ...
               int st = sws.addAnswer(to,qidd,idaa,c);              
               if (st>0) {
