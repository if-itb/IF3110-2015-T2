...
public class CreateAnswerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = createAnswer(accessToken,qid,content);
        if (result.equals("Respons oke!")) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<br>");
                out.println("<p class=\"blue\">Jawaban gagal dibuat</p>");
                out.println("</div>");
                out.println("</body>");
                out.println("</html>");
            }
    ...
    private String createAnswer(java.lang.String accessToken, int qid, java.lang.String content) {
