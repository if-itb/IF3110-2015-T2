...
import com.wbd.ans.AnswerWS_Service;
...
public class Test extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                int i = 47;
                java.util.List<com.wbd.ans.Answer> result = getAnswerByQID(i);
                out.println("Result: " + result);
                for (com.wbd.ans.Answer answer : result){
    ...
    private java.util.List<com.wbd.ans.Answer> getAnswerByQID(int qid) {
