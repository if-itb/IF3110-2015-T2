...
<jsp:include page="header.jsp" flush="true"/>
    <div class="container">
        <h2 class="topic"><a class="topic" href="question?id=<c:out value="${question.id}"/>"><c:out value="${question.topic}"/></a></h2>
        <hr class="heading">
            ...
            <c:if test="${fn:length(answers) > 0}">
                <h2>${fn:length(answers)} Answer${fn:length(answers) > 1 ? "s" : ""}</h2>
                <hr class="heading">
