	...
	<div class="inner">
		...
		<div id="answerForm">
			...
			<form onsubmit="return validasi(this);" class="form makeQuestion" method="POST" action="Answer">
				<div class="innerForm">
					<textarea class="textArea disabled-form" name="content" placeholder="Sign In to answer." disabled></textarea>
				</div>
				<div class="innerForm">
					<input class="submitButton disabled-button" type="submit" value="Send Answer" disabled>
				</div>
			</form>
		</div>
