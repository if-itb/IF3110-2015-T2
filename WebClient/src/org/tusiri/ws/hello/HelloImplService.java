 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://hello.ws.tusiri.org/", wsdlLocation = "http://localhost:8080/SOAP-WS/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://hello.ws.tusiri.org/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAP-WS/hello?wsdl");
    ...
    public Hello getHelloImplPort() {
        return super.getPort(new QName("http://hello.ws.tusiri.org/", "HelloImplPort"), Hello.class);
    }
    ...
    public Hello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.ws.tusiri.org/", "HelloImplPort"), Hello.class, features);
    }
