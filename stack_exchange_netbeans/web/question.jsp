...
<div class="container">
    ...
    <div id="question-page">
        ...
        <div class="question" id="question-   ">
            <div class="row">
                <div class="col_vote">
                    <a title="Click to Upvote" href="http://localhost:8080/stack_exchange_netbeans/UpVoteQuestionServlet?question_id=<c:out value="${question.id}"/>&token=<c:out value="${token}"/>&from=question" onclick="   " id="increase-vote">
                    ...
                    <a title="Click to Downvote" href="http://localhost:8080/stack_exchange_netbeans/DownVoteQuestionServlet?question_id=<c:out value="${question.id}"/>&token=<c:out value="${token}"/>&from=question" onclick="   " id="decrease-vote">
            ...
            <div class="controls" style="border-bottom:0px" align="right">
                ...
                <span class="link_edit"><a class="link_edit" title="Click here to edit" href="http://localhost:8080/stack_exchange_netbeans/EditQuestionServlet?question_id=<c:out value="${question.id}"/>&token=<c:out value="${token}"/>">edit</a></span> |
                <span class="link_delete"><a class="link_delete" title="Click here to delete" href="http://localhost:8080/stack_exchange_netbeans/DeleteQuestionServlet?question_id=<c:out value="${question.id}"/>&token=<c:out value="${token}"/>" onclick="      ">delete</a></span>
            </div>
        </div>
    </div>
    ...
    <div class="answers">
		...
		<div class="answer underline" style="width:100%" id="answer-  ">
                	<div class="row">
                		<div class="col_vote">
        				<a title="Click to Upvote" href="http://localhost:8080/stack_exchange_netbeans/UpVoteAnswer?question_id=<c:out value="${question.id}"/>&answer_id=<c:out value="${answers.id}"/>&token=<c:out value="${token}"/>" id="increase-vote">
					<img src="assets/img/up.png" width="32" height="32"><br>
					</a>
                                    <span id="answer-vote-count-"><font size = "5" color ="blue"><c:out value="${answers.vote}"/></font></span><br>
					<a title="Click to Downvote" href="http://localhost:8080/stack_exchange_netbeans/DownVoteAnswer?question_id=<c:out value="${question.id}"/>&answer_id=<c:out value="${answers.id}"/>&token=<c:out value="${token}"/>" id="decrease-vote">
					<img src="assets/img/down.png" width="32" height="32">
					</a>
				</div>
				<div class="col_content">
